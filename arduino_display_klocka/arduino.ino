...
void loop() {
  ...
  //CLOCK
// Send Day-of-Week to serial monitor
  ...
  display.clearDisplay();//clear display
    ...
    display.print("TIME:");//print out time on the display
    display.print(rtc.getTimeStr());//print out the clocks time on the display
